...
import SETUP_NEW_SINGLE_PLAYER_MATCH from "../cadence/transactions/rock_paper_scissors_game/game_player/setup-new-singleplayer-match";
import GET_GAME_PLAYER_ID from "../cadence/scripts/rock_paper_scissors_game/get_game_player_id";
import SUBMIT_BOTH_SINGLE_PLAYER_MOVES from "../cadence/transactions/rock_paper_scissors_game/game_player/submit-both-singleplayer-moves";
import GET_COLLECTION_IDS from "../cadence/scripts/game_piece_nft/get_collection_ids";
import GET_RPS_WIN_LOSS from "../cadence/scripts/game_piece_nft/get-rps-win-loss";
import {userAuthorizationFunction, adminAuthorizationFunction} from "../utils/authz-functions"
import RESOLVE_MATCH_AND_RETURN_NFTS from "../cadence/transactions/rock_paper_scissors_game/game_player/resolve-match-and-return-nfts";
